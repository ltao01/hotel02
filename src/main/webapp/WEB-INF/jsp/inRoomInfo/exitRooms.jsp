    ...
    <form class="layui-form layui-form-pane" action="" lay-filter="exitInRoomInfoForm" style="margin-left: 50px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="rooms.roomNum" id="roomsNum" lay-verify="required" autocomplete="off" class="layui-input" disabled>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="text" name="rooms.roomType.roomPrice" id="onePrice" autocomplete="off" class="layui-input" disabled>
                </div>
            </div>
            <div class="layui-inline">
        ...
        <div class="layui-form-item layui-form-text" style="width: 600px;">
            ...
            <div class="layui-input-block">
                <textarea rows="2" placeholder="请输入内容" name="remark" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
